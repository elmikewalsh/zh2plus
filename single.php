<?php get_header(); ?>
        ...
        <h6><?php echo __('By:'); ?> <?php if ( get_theme_mod('zh2plus_author_link') ) { ?><a <?php echo ( get_theme_mod( 'zh2plus_extlink' ) ) ? "target='_blank'" : "" ?> href="<?php the_author_url(); ?>"><?php the_author(); ?></a><?php } else { the_author_posts_link(); } ?></h6>
